...
from utils import DiabeticRetinopathyGradingDataset
...
class SelfSupervisedMethod(pl.LightningModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Create dataset
        # self.dataset = DiabeticRetinopathyGradingDataset
    ...
    def configure_optimizers(self):
        ...
        # if self.hparams.optimizer_name == "adam": encoding_optimizer = adam_optimizer
